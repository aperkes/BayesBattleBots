...
for s_i in range(6):
    for e_j in range(6):
        for l_k in range(6):
            ...
            pilot_fish = Fish(0,update_method=params.u_method,effort_method=params.effort_method,fight_params=params.outcome_params)

            fishes = [Fish(n,likelihood=pilot_fish.naive_likelihood,update_method=params.u_method,effort_method=params.effort_method) for n in range(7)]
