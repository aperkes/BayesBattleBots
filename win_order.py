...
ax.bar([1,2,5,6],[win_count1,win_count2,sa_win,sa_loss],color=['gold','grey','gold','gray'])
ax.set_xticks([1,2,5,6])
ax.set_xticklabels(['win','loss','win_sa','loss_sa'])
...
ax2.plot(c_loss.loser.xs,c_loss.loser.prior,color='gray')
