...
axes[0,0].set_ylim([-2.1,2.1])
axes[0,0].set_yticks([-2.00,-1.00,0.00,1.00,2.00])
#axes[0,0].set_yticklabels(['-2.00','-1.00','0.00','1.00','2.00'])
#axes[0,0].set_yticklabels(np.round(np.arange(-2,2.1),4))

axes[1,0].set_ylim([-0.061,0.061])
axes[1,0].set_yticks([-0.06,-0.03,0,0.03,0.06])

axes[2,0].set_ylim([-0.11,.11])
axes[2,0].set_yticks([-0.10,-0.05,0,0.05,0.10])
